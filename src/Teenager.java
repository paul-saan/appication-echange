...
public class Teenager implements Serializable {
    ...
    */
    ...
    public boolean compatibleWithGuest(Teenager other){
        return isCompatibleWithAnimalAllergy(other) && isCompatibleWithFoodAllergy(other) && isCompatibleWithCountry(other);
    }
    ...
    public boolean isCompatibleWithAnimalAllergy(Teenager other){
        ...
        || (this.requirements.get(CriterionName.GUEST_ANIMAL_ALLERGY).getValue().equals("no") && other.requirements.get(CriterionName.HOST_HAS_ANIMAL).getValue().equals("yes"));
    }
    ...
    public boolean isCompatibleWithFoodAllergy(Teenager other){
        ...
        for(int i = 0; i < tabGuestFoodConstraint.length-1; i ++){
