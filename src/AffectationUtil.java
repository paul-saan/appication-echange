...
public class AffectationUtil {
      ...
      public static final double INITIAL_WEIGHT = 100;
    ...
    */
    ...
    public static GrapheNonOrienteValue<Teenager> creationGraphe(ArrayList<Teenager> guest, ArrayList<Teenager> host, History affect){
     ...
     public static List<Arete<Teenager>> affectation(List<Teenager> promo, Country guest, Country host,History history){
        ArrayList<Teenager> teenHost = AffectationUtil.selectionPays(promo, host);
        ArrayList<Teenager> teenGuest = AffectationUtil.selectionPays(promo, guest);
        GrapheNonOrienteValue<Teenager> graphe = new GrapheNonOrienteValue<Teenager>();
        creationGraphe(teenGuest, teenHost, history);
